...
public class IntentionTest {
  ...
  public void intention() {
    ...
    assertThat(driver.findElement(By.xpath("//nb-card-header[contains(.,\'Promotion Codes\')]")).getText(), is("Promotion Codes"));
    driver.findElement(By.cssSelector(".user-name")).click();
    driver.findElement(By.cssSelector(".ng-tns-c98-12 > .menu-title")).click();
  }
}
